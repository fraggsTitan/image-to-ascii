...
public class ImageController {
    ...
    @PostMapping("/ascii")
    public List<CharCountMap> convertImage(@RequestParam MultipartFile file, @RequestParam String mapping, @RequestParam(required = false) Integer height,
                                           @RequestParam(required = false) Integer width,@RequestParam(required = false) Integer scale,@RequestParam String format) throws IOException {
    ...
    public List<GIFCharMap>convertGIF(@RequestParam MultipartFile file, @RequestParam String mapping, @RequestParam(required = false) Integer height,
                                      @RequestParam(required = false) Integer width,@RequestParam(required = false) Integer scale) throws IOException {
    ...
    public List<CharCountMap>cropAndBuildImage(@RequestParam MultipartFile file, @RequestParam String mapping, @RequestParam(required = false) Integer height,
                                             @RequestParam(required = false) Integer width,
                                             @RequestParam(required = false) Integer scale,@RequestParam String format,
